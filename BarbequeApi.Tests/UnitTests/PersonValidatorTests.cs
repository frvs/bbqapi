...
namespace BarbequeApi.Tests.UnitTests
{
    public class PersonValidatorTests
    {
        ...
        public async Task ValidatePersonDtoReturnsFalseBeucaseOfBeingNull()
        {
            ...
            Assert.Equal("PersonDto should not be null.", errorMessages.First());
        }
        ...
        public async Task ValidatePersonDtoReturnsFalseBeucaseOfName(string name)
        {
            ...
            Assert.Single(errorMessages);
            Assert.Equal(
                "PersonDto.Name should not be null, empty string or white spaces.",
                errorMessages.First());
        }
        ...
        public async Task ValidatepersonDtoReturnsFalseBeucaseOfNegativeMoneyShare()
        {
            ...
            Assert.Equal(
                "PersonDto.BeverageMoneyShare should not be negative.",
                errorMessages.First());
            Assert.Equal(
                "PersonDto.FoodMoneyShare should not be negative.",
                errorMessages.Last());
        }
